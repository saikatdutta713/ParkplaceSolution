...
$sql = "SELECT `id`,`name`,`email`,`subject`,`message`,`date` FROM `message` WHERE `id` LIKE '%$search_value%' OR `name` LIKE '%$search_value%' OR `email` LIKE '%$search_value%' OR `subject` LIKE '%$search_value%' OR `message` LIKE '%$search_value%' OR `date` LIKE '%$search_value%'";
