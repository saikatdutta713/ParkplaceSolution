...
// print_r(mysqli_fetch_assoc($all_products));
if (mysqli_num_rows($all_products) > 0) {
	while ($row = mysqli_fetch_assoc($all_products)) {
		...
		<tr class="text-center">
			...
			<td>
				<label class="switch"><input type="checkbox" id="switch" data-id="<?php echo $row['id']; ?>" <?php echo ($row['special'] == 1 ? 'checked' : ''); ?>><span class="slider round"></span></label>
			</td>
			<td>
