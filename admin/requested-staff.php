...
<body>
			...
			<div class="container">
				<div class="row-2 row">
					<div class="col">
						<div class="booking">
							<div class="card">
								<div class="card-header unselectable">Requested Staff List
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			// Load table records
			$.ajax({
				url: 'api/staff/requested_staff/requested-staff-ajax-load.php',
				type: 'post',
			...
			$(".staff-table-filter").keyup(function(event) {
				var x = $(".staff-table-filter").val();

				$.ajax({
					url: 'api/staff/requested_staff/requested-staff-ajax-live-search.php',
					type: 'POST',
					data: {
						search: x
					},
			...
			$(document).on('click', '.accept-button', function(event) {
				...
				$.ajax({
					url: 'api/staff/requested_staff/requested-staff-ajax-accept.php',
					type: 'POST',
					data: {
						req_id: x
					},
			...
			$(document).on('click', '.reject-button', function(event) {
				...
				$.ajax({
					url: 'api/staff/requested_staff/requested-staff-ajax-reject.php',
					type: 'POST',
					data: {
						req_id: x
					},
