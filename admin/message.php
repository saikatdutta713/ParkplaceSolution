...
<body>
			...
			<div class="container">
				<div class="row-2 row">
					<div class="col">
						<div class="booking">
							<div class="card">
								<div class="card-header unselectable">Messages
									<span class="search float-right">
										<input class="message-table-filter" id="message-search-name" type="text" name="message-search-name" placeholder="search for any field">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			// Load messages
			$.ajax({
				url: 'api/message/message-ajax-load.php',
				type: 'post',
			...
			// live search
			$(".message-table-filter").keyup(function(event) {
				var x = $(".message-table-filter").val();

				$.ajax({
					url: 'api/message/message-ajax-live-search.php',
					type: 'POST',
					data: {
						search: x
					},
			...
			$(document).on('click', '.delete-button', function(event) {
				...
				$.ajax({
					url: 'api/message/message-ajax-delete.php',
					type: 'POST',
					data: {
						id: x
					},
