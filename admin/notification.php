...
<body>
			...
			<div class="container">
				<div class="row-2 row">
					<div class="col">
						<div class="booking">
							<div class="card">
								<div class="card-header unselectable">Notifications</div>
								<div class="card-body">
									<table>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			// Load messages
			$.ajax({
				url: 'api/notification/notification-ajax-load.php',
				type: 'post',
			...
			$(document).on('click', '.delete-button', function(event) {
				...
				$.ajax({
					url: 'api/notification/notification-ajax-delete.php',
					type: 'POST',
					data: {
						id: x
					},
